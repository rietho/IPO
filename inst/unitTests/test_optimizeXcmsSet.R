test_ipo <- function() {
  ...
  resultPP <- optimizeXcmsSet(mzmlfile, paramsPP, subdir=NULL, nSlaves=4, 
  ...
  resultPPCamera <- optimizeXcmsSet(mzmlfile, paramsPP, isotopeIdentification="CAMERA", 
                                    subdir=NULL, nSlaves=4, ppm=15, maxcharge=2)
  ...
  resultRG <- optimizeRetGroup(xset, paramsRG, subdir=NULL, nSlaves=4)
