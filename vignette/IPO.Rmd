...
'xcms' and 'rsm' are required. The R-package 'mtbls2' is 
recommended. The optimization process looks as following:

<br>
<b>IPO optimization process</b>
<p><img src="FlowChart.jpg"" width="695" height="745"</p>
...
<b>Install RTools</b><br><br>
  For windows:<br>
    Download and install RTools from [http://cran.r-project.org/bin/windows/Rtools/](http://cran.r-project.org/bin/windows/Rtools/)<br>
  For Unix: <br>
...
install_github("sneumann/mtbls2") #for examples of optimization of retention time correction and grouping parameters
...
#  opt_params <- sum(unlist(lapply(peakpickingParameters, function(x) {length(x)==2})))
#  
#  plots <- c()
...
#    mtext(paste('Response surface models of DoE', i), side = 3, line = -2, outer = TRUE)
#  } 
...
<br>
<b>Response surface models of DoE 1 of retention time correction and grouping parameter optimization</b>
<p><img src="rsmDirectory/retgroup_rsm_1.jpg"" width="695" height="348"</p>
<br>
<b>Response surface models of DoE 2 of retention time correction and grouping parameter optimizationn</b>
<p><img src="rsmDirectory/retgroup_rsm_2.jpg"" width="695" height="348"</p>
<br>
<b>Response surface models of DoE 3 of retention time correction and grouping parameter optimization</b>
<p><img src="rsmDirectory/retgroup_rsm_3.jpg"" width="695" height="348"</p>
<br>
<b>Response surface models of DoE 4 of retention time correction and grouping parameter optimization</b>
...
# opt_params <- sum(unlist(lapply(retcorGroupParameters, function(x) {length(x)==2})))
# 
# plots <- c()
# for(i in 1:(opt_params-1)) {
#   for(j in (i+1):opt_params) {
